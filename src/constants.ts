import { DistributionWorkflowRegistrationOptions, EditorWorkflowRegistrationOptions, OutputAttributesRegistrationOptions } from '@celtra/eagle-extensions-sdk'
...
export const EXAMPLE_EDITOR_WORKFLOW: EditorWorkflowRegistrationOptions = {
    label: 'Example Extension',
    iconUrl: icon, // Icon can be encoded data or an externally available URL
    initialWindowSize: { width: 600, height: 600 },
}
